...
(function (App) {
    var AppCtrl = (function () {
        ...
        function AppCtrl($scope, $timeout, $location, $mapService, $layerService, $messageBusService, $dashboardService, geoService) {
            var _this = this;
            this.$scope = $scope;
            ...
            $scope.$watch('vm.showNavigation', function () {
                $timeout(function () {
                    _this.autocollapse();
                }, 20);
            });
            $scope.$watch('vm.$layerService.noFilters', function () {
                $timeout(function () {
                    _this.autocollapse();
                }, 20);
            });
            $scope.$watch('vm.$layerService.project.mcas', function () {
                $timeout(function () {
                    _this.autocollapse();
                }, 20);
            });
            $messageBusService.subscribe('project', function (action) {
                if (action === 'loaded') {
                    _this.$dashboardService.widgetTypes['e2muploadwidget'] = {
                        id: 'e2muploadwidget',
        ...
        Object.defineProperty(AppCtrl.prototype, "showNavigation", {
            get: function () { return this.$dashboardService._search && this.$dashboardService._search.isActive; },
            enumerable: true,
            configurable: true
        });
        /**
        ...
        AppCtrl.prototype.autocollapse = function () {
            var maxTabs = 7;
